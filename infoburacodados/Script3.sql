...
CREATE TABLE EquipamentoSaida (
	...
	PRIMARY KEY (id_saida,id_equipamento)
);
...
ALTER TABLE Relatorio ADD CONSTRAINT Relatorio_OrdemServico_FK FOREIGN KEY (id_OS)
...
ALTER TABLE OrdemServico ADD CONSTRAINT OrdemServico_Buraco_FK FOREIGN KEY (id_buraco)
	REFERENCES Buraco (id)
	ON DELETE CASCADE;

ALTER TABLE OrdemServico ADD CONSTRAINT OrdemServico_FaturaMensal_FK FOREIGN KEY (mes)
	REFERENCES FaturaMensal (mes)
	ON DELETE CASCADE;

ALTER TABLE OSS ADD CONSTRAINT OSS_OrdemServico_FK FOREIGN KEY (id_OS)
	REFERENCES OrdemServico (id)
	ON DELETE CASCADE;

ALTER TABLE OSS ADD CONSTRAINT OSS_Saida_FK FOREIGN KEY (id_saida)
	REFERENCES Saida (id)
	ON DELETE CASCADE;
...
ALTER TABLE EquipamentoSaida ADD CONSTRAINT EquipamentoSaida_Saida_FK FOREIGN KEY (id_saida)
	REFERENCES Saida (id)
	ON DELETE CASCADE;

ALTER TABLE EquipamentoSaida ADD CONSTRAINT EquipamentoSaida_Equipamento_FK FOREIGN KEY (id_equipamento)
...
ALTER TABLE Material ADD CONSTRAINT Material_Saida_FK FOREIGN KEY (id_saida)
	REFERENCES Saida (id)
	ON DELETE CASCADE;
...
ALTER TABLE Foto ADD CONSTRAINT Foto_Notificacao_FK FOREIGN KEY (id_notificacao)
...
ALTER TABLE UsuarioFatura ADD CONSTRAINT UsuarioFatura_FaturaMensal_FK FOREIGN KEY (mes)
	REFERENCES FaturaMensal (mes)
	ON DELETE CASCADE;
